...
//Overview and menubar JS
    document.querySelectorAll(".readMoreLink").forEach((element,index)=>{
        ...
        class floorCarousel {
            ...
            floorSetupImageClickEvents() {
                this.floorOverlay = document.querySelectorAll(".floor-imageContainer");
                this.floorOverlay.forEach((slide,index)=>{
                    slide.classList.add("popupTrigger");
                    slide.setAttribute("data-heading","View Plan");
        ...
        class GalleryCarousel {
            constructor() {
                // Get the original slides
                this.originalSlides = Array.from(document.querySelectorAll('.gallerySlide'));
                ...
                // Extract data from original slides
                this.originalSlides.forEach(slide => {
                    const img = slide.querySelector('.galleryImage');
            ...
            gallerySetupImageClickEvents() {
                const slides = this.galleryTrack.querySelectorAll('.gallerySlide');
                slides.forEach((slide, index) => {
                    const img = slide.querySelector('.galleryImage');
                    img.addEventListener('click', () => {
                        // Calculate original image index
            ...
            galleryUpdateCarousel() {
                const gallerySlides = this.galleryTrack.querySelectorAll('.gallerySlide');
            ...
            galleryNextSlide() {
                ...
                // Reset position for seamless infinite scroll
                setTimeout(() => {
                    const totalSlides = this.galleryTrack.querySelectorAll('.gallerySlide').length;
        ...
        // document.querySelector(".rera-closeBtn").addEventListener("click",(e)=>{
        //     e.preventDefault();
        //     closePanel();
        // })
        ...
        document.querySelectorAll(".nav-item").forEach(element=>{
            element.addEventListener("click",(e)=>{
                ...
                for (i=0;i<navCount;i++) {
                    console.log(i);
                    if(document.querySelectorAll(".nav-item")[i].classList.contains("nav-active")){
                    document.querySelectorAll(".nav-item")[i].classList.remove("nav-active");}
                }
